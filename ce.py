...
if __name__ == "__main__":
    # combo_path = '/home/jly/echi2/data/ce/一比四/synergy.csv'  # 正负比1：4
    # random_seed = 42
    # folder_name = f'/home/jly/echi2/data/ce/一比四/'
    ...
    # single_path = "/home/jly/echi2/data/ce/single.csv"
    # path = f"/home/jly/echi2/data_process/ce/"
    ...
    combo_path = '/root/autodl-tmp/jly/echi/data/ce/一比四/synergy.csv'  # 正负比1：4
    random_seed = 42
    folder_name = f'/root/autodl-tmp/jly/echi/data/ce/'
    testdataset, traindataset = data_split(combo_path, random_seed=42,folder_name=folder_name)
    test_path = testdataset
    train_path = traindataset
    single_path = "/root/autodl-tmp/jly/echi/data/ce/single.csv"
    path = f"/root/autodl-tmp/jly/echi/data_process/ce/"
    test_process_nn, train_process_nn = combo_process_noid(test_path, train_path,path=path)
    single_process_nn = single_process(single_path,path=path)

    output_path = r'/root/autodl-tmp/jly/echi2/data/pro/amino acid/'
    ...
    # parser.add_argument('--dataset', type=str, default="CE")
